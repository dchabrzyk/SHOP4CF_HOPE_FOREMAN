...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE public."Steps" TO app_user;
...
--rollback GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE public."DefaultTaskPerformances" TO app_user;
