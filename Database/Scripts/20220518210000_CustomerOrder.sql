...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE public."CustomerOrders" TO app_user;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE public."CustomerOrderLines" TO app_user;
